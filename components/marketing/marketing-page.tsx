    ...
    <div className="relative mx-auto w-full max-w-5xl">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-black/10 bg-[#faf9f6] shadow-2xl shadow-black/10 dark:border-white/10 dark:bg-[#111110] dark:shadow-black/40">
        <div className="flex items-center justify-between border-b border-black/10 px-4 py-3 dark:border-white/10 sm:px-5">
          ...
          <div className="hidden items-center gap-6 text-[10px] font-bold uppercase tracking-[0.16em] text-black/60 dark:text-white/60 sm:flex">
            <span>Today</span>
            <span>History</span>
            <span>Settings</span>
          </div>
        ...
        <div className="grid md:grid-cols-[1fr_0.35fr]">
          <div className="p-6 sm:p-10">
            <div className="mb-8 flex items-end justify-between">
              <div>
                <p className="mb-2 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-black/45 dark:text-white/45">
                  Wednesday
                </p>
                <h3 className="text-2xl font-bold tracking-[-0.03em] text-black dark:text-white sm:text-3xl">
                  September 9
                </h3>
              </div>

              <div className="text-right">
                <p className="font-mono text-[10px] font-bold uppercase tracking-[0.16em] text-black/45 dark:text-white/45">
                  Day
                </p>
                <p className="mt-1 text-xs font-bold text-black/70 dark:text-white/70">
                  2 / 3
                </p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <PreviewSection title="Notes">
                <div className="rounded-lg border border-black/8 bg-white/60 p-4 text-sm leading-6 text-black/60 dark:border-white/8 dark:bg-white/[0.03] dark:text-white/55">
          ...
          <div className="hidden border-l border-black/10 bg-black/[0.015] p-6 dark:border-white/10 dark:bg-white/[0.015] md:block">
            <p className="font-mono text-[9px] font-bold uppercase tracking-[0.2em] text-black/45 dark:text-white/45">
              Progress
            </p>
            ...
            <p className="mt-3 text-xs leading-5 text-black/55 dark:text-white/50">
        ...
        <div className="border-t border-black/10 bg-black/[0.02] px-6 py-4 dark:border-white/10 dark:bg-white/[0.02] sm:px-10">
          <div className="flex items-center justify-between">
            <span className="font-mono text-[9px] font-bold uppercase tracking-[0.18em] text-black/40 dark:text-white/40">
              Pro Daily
            </span>
      ...
      <main className="min-h-screen overflow-hidden bg-[#f7f6f2] text-[#111110] dark:bg-[#0c0c0b] dark:text-[#f4f3ef]">
        <header className="relative z-20 border-b border-black/10 dark:border-white/10">
          <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-8">
            <Link
              href="/"
              className="flex items-center gap-2 text-sm font-bold tracking-[-0.02em]"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href={ctaHref}
                className="group flex items-center gap-2 rounded-full bg-black px-5 py-2.5 text-xs font-bold text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:bg-white dark:text-black"
              >
                {ctaLabel}
              ...
              <button
                type="button"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-black/15 sm:hidden dark:border-white/15"
        ...
        <section className="relative">
          ...
          <div className="relative mx-auto max-w-6xl px-5 pb-24 pt-20 sm:px-8 sm:pb-32 sm:pt-28">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-black/10 bg-white/50 px-3 py-1.5 font-mono text-[9px] font-bold uppercase tracking-[0.18em] text-black/55 dark:border-white/10 dark:bg-white/[0.03] dark:text-white/50">
                <span className="h-1.5 w-1.5 rounded-full bg-black dark:bg-white" />
                A better daily work page
              </div>

              <h1 className="text-[3.2rem] font-bold leading-[0.98] tracking-[-0.055em] sm:text-6xl md:text-7xl">
                Plan today.
                <br />
              ...
              <p className="mx-auto mt-7 max-w-2xl text-base font-medium leading-7 text-black/65 dark:text-white/55 sm:text-lg">
              ...
              <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
                <Link
                  href={ctaHref}
                  className="group flex w-full items-center justify-center gap-2 rounded-full bg-black px-6 py-3.5 text-sm font-bold text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:bg-white dark:text-black sm:w-auto"
                >
                  {ctaLabel}
                ...
                <a
                  href="#how-it-works"
                  className="flex w-full items-center justify-center gap-2 rounded-full border border-black/15 px-6 py-3.5 text-sm font-bold text-black/70 transition hover:border-black/30 hover:text-black dark:border-white/15 dark:text-white/70 dark:hover:border-white/30 dark:hover:text-white sm:w-auto"
                >
                  See how it works
              ...
              <div className="relative">
                <div className="rounded-2xl border border-black/10 bg-white/50 p-5 dark:border-white/10 dark:bg-white/[0.03] sm:p-7">
                  <div className="flex items-center justify-between border-b border-black/8 pb-4 dark:border-white/8">
                    ...
                    <History className="h-4 w-4 text-black/30 dark:text-white/30" />
                  </div>
                  ...
                  <div className="mt-5 space-y-2">
                    {[
                      ...
                      >
                        ...
                        <span className="font-mono text-[10px] font-bold text-black/50 dark:text-white/40">
                          {progress}
                        </span>
                      </div>
                    ))}
        ...
        <section className="border-y border-black/10 dark:border-white/10">
          <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <Link
                href={ctaHref}
                className="group mx-auto mt-8 flex w-fit items-center gap-2 rounded-full bg-black px-6 py-3.5 text-sm font-bold text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:bg-white dark:text-black"
              >
                {ctaLabel}
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
              </Link>
